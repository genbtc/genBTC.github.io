 ...
 * MODIFIED BY GENBTC - 5-9-17 + 7/23/17
 */

/*Localstorage fix*/
(function() {
    window.localStorage = document.localStorage;
})();
(() => {
...
var settingsPanel, emoteModule, utils, quickEmoteMenu, opublicServers, voiceMode, pluginModule, themeModule, customCssEditor, dMode, emoteNamePopup;
var jsVersion = 1.79;
...
class V2_PublicServers {
    ...
    render() {
        let root = this.root;
        if (!root) {
            console.log("V2_PublicServers FAILED TO LOCATE ROOT: .layers");
            return;
        }
...
class V2_SettingsPanel_Sidebar {
    ...
    render() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel_Sidebar FAILED TO LOCATE ROOT: [class*=side] > [class*=item]:not([class*=Danger])");
            return;
        }
        BDV2.reactDom.render(this.component, root);
    }
...
class V2_SettingsPanel {
    ...
    renderCoreSettings() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel-Core FAILED TO LOCATE ROOT: .layer .ui-standard-sidebar-view");
            return;
        }
    ...
    renderEmoteSettings() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel-Emote FAILED TO LOCATE ROOT: .layer .ui-standard-sidebar-view");
            return;
        }
    ...
    renderCustomCssEditor() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel-Css FAILED TO LOCATE ROOT: .layer .ui-standard-sidebar-view");
            return;
        }
    ...
    renderPluginPane() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel-Plugin FAILED TO LOCATE ROOT: .layer .ui-standard-sidebar-view");
            return;
        }
    ...
    renderThemePane() {
        let root = this.root;
        if (!root) {
            console.log("V2_SettingsPanel-Theme FAILED TO LOCATE ROOT: .layer .ui-standard-sidebar-view");
            return;
        }
